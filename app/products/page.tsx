        ...
        <>
            ...
            <div className="container mx-auto section-padding pt-0 flex flex-col gap-4">
                ...
                <ButtonGroup className="w-full">
                    ...
                    />
                    <Button
                        className="py-6 bg-dark-primary hover:bg-myprimary cursor-pointer"
                    ...
                    <div className="md:w-1/5 w-full">
                        <div className="sticky top-24 rounded-xl border p-4 bg-white space-y-4">
                            <button
                                ...
                                className={`w-full font-bold text-left px-3 py-2 rounded cursor-pointer ${category === "All"
                            ...
                            {Object.entries(categories).map(([parent, subs]) => (
                                <div key={parent} className="space-y-1">
                                    ...
                                    <button
                                        ...
                                        className={`w-full text-left px-3 py-2 font-semibold rounded cursor-pointer ${category === parent
                                            ? "bg-myprimary text-white"
                                            : "hover:bg-myprimary/15"
                                            }`}
                                    >
                                        ...
                                        <div className="ml-4 space-y-1">
                                            {subs.map((s) => (
                                                <button
                                                    ...
                                                    className={`block w-full text-left text-sm px-3 py-1 rounded transition cursor-pointer ${sub === s
